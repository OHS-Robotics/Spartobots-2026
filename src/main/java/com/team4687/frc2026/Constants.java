...
public final class Constants {
  ...
  public static final SwerveModuleSimulationConfig 
        FRONT_LEFT_MODULE_CONFIG = DEFAULT_SWERVE_SIM_CONFIG,
        FRONT_RIGHT_MODULE_CONFIG = DEFAULT_SWERVE_SIM_CONFIG,
        BACK_LEFT_MODULE_CONFIG = DEFAULT_SWERVE_SIM_CONFIG,
        BACK_RIGHT_MODULE_CONFIG = DEFAULT_SWERVE_SIM_CONFIG;
...
// Create and configure a drivetrain simulation configuration
  public static final DriveTrainSimulationConfig driveTrainSimulationConfig = DriveTrainSimulationConfig.Default()
        ...
        .withSwerveModules(FRONT_LEFT_MODULE_CONFIG, FRONT_RIGHT_MODULE_CONFIG, BACK_LEFT_MODULE_CONFIG, BACK_RIGHT_MODULE_CONFIG)
