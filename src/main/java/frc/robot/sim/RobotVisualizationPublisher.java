...
public class RobotVisualizationPublisher {
  ...
  private static final int componentIndexHopperExtension = 1;
  private static final int componentIndexShooterHood = 2;
  private static final int robotComponentCount = 3;
  ...
  private static final Translation3d hopperExtensionRetractedOriginOnRobot =
      new Translation3d(-0.05, 0.0, 0.24);
  private static final Translation3d hopperExtensionAxisOnRobot = new Translation3d(0.20, 0.0, 0.0);
  ...
  public RobotVisualizationPublisher(Intake intake, Hopper hopper, Shooter shooter) {
    this.intake = intake;
    this.hopper = hopper;
  ...
  private Pose3d[] getRobotRelativeComponentPoses() {
    ...
    Translation3d hopperPosition =
        hopperExtensionRetractedOriginOnRobot.plus(
            hopperExtensionAxisOnRobot.times(hopperExtensionNormalized));
    componentPoses[componentIndexHopperExtension] = new Pose3d(hopperPosition, new Rotation3d());
